...
class ServiceCarti:
    ...
    def create(self, cod, titlu, autor): #def create(self, cod, titlu, autor, descriere):
        """
    ...
    def update(self, cod, titlu, autor): #def update(self, cod, titlu, autor, descriere):
        """
        ...
        """
        newCarte = Carte(cod, titlu, autor)
...
def testCreateCarte():
    ...
    carte = srv.create(1, "Carte", "Autor")
...
def testRemoveCarte():
    ...
    val = ValidatorCarte()
    srv = ServiceCarti(val, repo)
    srv.create(1, "Carte1", "Autor1")
    srv.create(2, "Carte2", "Autor2")
