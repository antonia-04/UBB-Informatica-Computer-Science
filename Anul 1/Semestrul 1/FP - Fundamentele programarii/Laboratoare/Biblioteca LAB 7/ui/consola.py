...
class Consola:
    def __init__(self, srv_Inchirieri, srv_Carti, srv_Clienti):
    ...
    def print_all_carti(self):
        ...
        if len(lista_carti) == 0:
            ...
            for carte in lista_carti:
                print(f"Cod: {carte.getCod()} Titlu: {carte.getTitlu()} Autor: {carte.getAutor()} ")
    ...
    def print_all_clienti(self):
        ...
        if len(lista_clienti) == 0:
            ...
            for client in lista_clienti:
                print(f"ID: {client.getID()} Nume: {client.getNume()} ")
    ...
    def __add_carti(self):
        ...
        try:
            added_carte = self.__srv_Carti.create(cod, titlu, autor)
    ...
    def __add_clienti(self):
        ...
        try:
            ...
            added_client = self.__srv_Clienti.create(id, nume)
    ...
    def __update_carti(self):
        ...
        try:
            ...
            self.__srv_Carti.update(cod, titlu, autor)
    ...
    def __update_clienti(self):
        ...
        try:
            ...
            self.__srv_Clienti.update(id, nume)
