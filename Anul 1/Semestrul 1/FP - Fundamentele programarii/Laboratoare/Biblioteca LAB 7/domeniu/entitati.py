#LAB 7: Pentru cei care au reprezentat entitatile cu clase: eliminati un atribut al clasei (nu il stergeti de tot, doar il comentati)
#Carte = descriere, Client = cnp
class Carte:
    nr_carti = 0

    def __init__(self, cod, titlu, autor): #def __init__(self, cod, titlu, autor, descriere):
        self.__cod = int(cod)
        self.__titlu = titlu
        self.__autor = autor
    ...
    def __str__(self):
        ...
        :return: a string
        """
        return "Cod: " + str(self.__cod) + "| Titlu: " + str(self.__titlu) + "| Autor: " + str(self.__autor)
...
class Client:
    ...
    def __init__(self, id, nume): #def __init__(self, id, nume, cnp):
        """
...
def testEqualCarte():
    ...
    carte2 = Carte(12, "Oameni VS Tehnologie", "James Bartlett")
    assert carte2 == carte1

def testEqualClient():
    client1 = Client(1, "Ion")
    client2 = Client(1, "Ion")
