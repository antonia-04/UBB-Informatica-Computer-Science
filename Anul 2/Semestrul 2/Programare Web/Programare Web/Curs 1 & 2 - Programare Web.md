...
Paginile din directorul public_html vor fi servite browserelor de catre un server Web Apache care ruleaza pe www.scs.ubbcluj.ro. Astfel, aceste pagini pot sa fie accesate cu un URL de forma:
